...
// 2020-12-13
window.M = new Phos(); 
// non-module JS block cannot use Phos() as constructor, hence initialize object first, then export object
// GLAVA, tank old code still use lower case m = new Phos(), upper case M for something else
// this is clean break
